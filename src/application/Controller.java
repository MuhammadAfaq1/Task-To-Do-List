...
public class Controller implements Initializable{
	...
	@FXML private TableColumn<Product,LocalDate>  colDate;
	@FXML private TableColumn<Product,String>  colTime;
	@FXML private TableColumn<Product,String>  colSubject;
	@FXML private TableColumn<Product,String>  colPlace;
...
//-------------------------------INSERT-------------------------------	
	public void addbtn() {
		...
		if (subjectField.getText()!="" && timeField.getText()!=""  && Placefield.getText()!=""  && Descriptionfield.getText()!="" )
		{
		Product  newproduct=new Product(subjectField.getText(),datepick.getValue(),timeField.getText(),Placefield.getText()
				,Descriptionfield.getText() );
		//manipulate product
			if (subjectField != null  && datepick  != null && Placefield !=null && Descriptionfield != null && timeField != null ) {							
 ...
 //-----------------DELETE--------------------
	public void deletebtn() throws IOException {
		...
		for (int i =0;i<products.size();i++) 
			text=products.get(i).getProductSubject() + "|" + products.get(i).getProductDate() + "|" + products.get(i).getProductTime() + 
